                      ...
                      {member.name === "Bernetta Lee" && (
                        <div className="absolute top-4 right-4 w-20 h-20">
                           <img
                             ...
                             alt="CPA Australia certified professional - Business Valuations expert"
                      ...
                      {member.name === "Denise Hall" && (
                        <div className="absolute top-4 right-4 w-32 h-24">
                           <img
                             ...
                             alt="Australian Valuers Institute - Professional Business Valuations certification"
                             className="w-full h-full object-contain"
                           />
                        </div>
                      )}
                      ...
                      {(member.name === "Adeel Momin" || member.name === "Zoran Sarabaca" || member.name === "Choon Ng" || member.name === "Fred Fareau") && (
                        <div className="absolute top-4 right-4 w-24 h-24">
                           <img
                             ...
                             alt="Registered Business Valuer certification - Expert Business Valuations professional"
                             className="w-full h-full object-contain"
                           />
                        </div>
                      )}
