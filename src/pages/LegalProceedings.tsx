        ...
        >
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center text-primary-foreground">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold mb-6 drop-shadow-lg">Business Valuations for Legal Proceedings & Disputes</h1>
                ...
                <div className="mb-16">
                  ...
                  <div className="prose prose-lg max-w-none text-muted-foreground">
                    <p className="text-xl mb-6">
                      Our business valuation reports are prepared with the understanding that they may be scrutinized in court proceedings. 
