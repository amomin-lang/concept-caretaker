                ...
                <div className="mb-16">
                  ...
                  <div className="prose prose-lg max-w-none text-muted-foreground">
                    ...
                    <p className="text-lg mb-8">
                      We analyse market conditions, competitive positioning, and buyer expectations to help you time your exit optimally and position your business for maximum value realisation. Our detailed reports provide actionable insights for value enhancement initiatives.
                    </p>
                  </div>
                </div>
